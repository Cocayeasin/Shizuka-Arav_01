...
module.exports.run = async ({ api, event, args }) => {
    ...
    if (args[0] == "admin") {
        let callback = () => api.sendMessage(
            {
                body: `———»ADMIN BOT«———\n❯ Name: 𝐂𝐨𝐜𝐚 𝐀𝐫𝐚𝐯\n❯ Facebook: https://facebook.com/61552846104112\n❯ Thanks for using ${global.config.BOTNAME} bot`,
        ...
        return request(encodeURI(`https://graph.facebook.com/61552846104112/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`))
